                ...
                <div class="col-md-12">
                    <div class="row">
                        <section class="col-md-12">
                            <article>
                                <h1>Ge Soif!</h1>
                                <p class="text-justify">C’est en se baladant dans la campagne Genevoise à vélo un dimanche bien ensoleillé que l’idée de ce projet est née. Tout
                        ...
                        <section>
                            ...
                            <article class="col-xs-12 col-sm-6 col-lg-6 col-md-6">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h4>Développeurs</h4>
                                        <p class="text-justify">Le développement s'est fait en plusieurs étapes, dans le cadre d'un atelier web dispensé au <a href="https://edu.ge.ch/site/cfpt-informatique/"  target="_blank">CFPT</a>.</p>
                                        <!-- Version 3.0 -->
                                        <div class="versions">
                            ...
                            <article class="col-xs-12 col-sm-6 col-lg-6 col-md-6">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h4>Graphisme</h4>
                                        <p class="text-justify">Les graphismes ont été créés dans le cadre d'un atelier graphique par des élèves de 3ème année qui maîtrisent les outils Adobe. Bravo pour leur créativité!</p>
                                        <!-- Version 3.0 -->
                                        <div class="versions">
                            ...
                            <article class="col-xs-12 col-sm-6 col-lg-6 col-md-6">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="text-justify">Plusieurs classes ont participé et aidé à la mise en production du projet, aux tests et à l'insertion de données.</p>
                                        <!-- Version 3.0 -->
                                        <div class="versions">
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <h5>L'équipe Gemprunte de la classe INP4B 2017</h5>
										 <h5>La direction de l'école pour leurs encouragements et soutien</h5>
