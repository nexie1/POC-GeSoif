        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-2">
                    <div class="sidebar-nav">
                        <div class="navbar navbar-default" role="navigation">
                            ...
                            <div class="navbar-collapse collapse sidebar-navbar-collapse" v-if="DisplayApropos" class="aPropos">
                                <ul class="nav navbar-nav">
                                    <li v-on:click="divActu"><a>Actualité</a></li>
                                    <li v-on:click="divEquipe"><a>Notre équipe</a></li>
                                    <li v-on:click="divPropos"><a>A propos</a></li>
                                </ul>
                            </div><!--/.nav-collapse -->
                        </div>
                    </div>
                ...
                <div class="col-sm-offset-1 col-lg-offset-1 col-md-offset-1  col-xs-12 col-sm-9 col-lg-9 col-md-9">
                    <!--  Actualité  -->
                    <div v-if="Displaypropos" class="container"> 
                        <div class="row">
